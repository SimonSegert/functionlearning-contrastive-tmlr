...
from . import models
RnnEncoder=models.RnnEncoder
WFEncoder=models.WFEncoder
from . import utils
plot_distribution=utils.plot_distribution
track_encoding=utils.track_encoding
#from . import evaluations
#WFClassificationExperiment=evaluations.WFClassificationExperiment
#ClassificationPerformanceExperiment=evaluations.ClassificationPerformanceExperiment
...
#this code is modified with respect to the original, so that we can save the state of the optimizer across several runs
def learn_encoder(x, encoder, disc_model,optimizer,window_size, w, gp_batch_size=10,lr=0.001, decay=0.005, mc_sample_size=20,
    ...
    for cv in range(n_cross_val):
        if 'waveform' in path:
            ...
            #in this case, we use the encoder passed in as an argument
